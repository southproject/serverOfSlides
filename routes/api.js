...
router.get('/resourceRel',passport.authenticate('bearer',{session:false}),CourseC.resourceRel);
router.get('/knowledgeRel',passport.authenticate('bearer',{session:false}),CourseC.knowledgeRel);
